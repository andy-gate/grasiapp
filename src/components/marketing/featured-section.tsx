        ...
        <div className="mt-12 grid gap-6 md:grid-cols-3">
          {itProjects.map((p) => (
            <Link
              key={p.id}
              href={`/it/${p.slug}`}
              className="group block rounded-xl border border-white/10 bg-[#0d1117]/60 p-6 backdrop-blur transition-all hover:border-brand-blue/40 hover:shadow-xl hover:shadow-brand-blue/10"
            >
